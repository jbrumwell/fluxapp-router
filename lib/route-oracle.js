 ...
 * @param {Object} meta
 */
RouteOracle.prototype.getRoute = function getRoute(path, meta) {
  var self = this;
  var notFound;
  var found;
 ...
 * @param {Object} route
 */
RouteOracle.prototype.addRoute = function addRoute(route) {
  if (! route.path) {
 ...
 * @param {Object} path
 */
RouteOracle.prototype._pullParams = function pullParams(route, path) {
 ...
 * @param {Object} route
 */
RouteOracle.prototype._methodMatch = function methodMatch(supplied, route) {
  var match = false;
...
module.exports = new RouteOracle();
